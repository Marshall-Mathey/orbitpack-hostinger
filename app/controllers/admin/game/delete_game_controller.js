...
let DeleteGameController = class DeleteGameController {
    adminGameService;
    ...
    async handle(ctx) {
        ...
        const { id } = params;
        try {
            const result = await this.adminGameService.deleteGame(id);
